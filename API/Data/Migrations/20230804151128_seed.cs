    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
      ...
      migrationBuilder.InsertData(
          ...
          values: new object[,]
          {
                    ...
                    { 6, "Aenean ornare tortor nec odio rhoncus dignissim. Aliquam orci magna, semper sed pulvinar non, dictum vitae turpis. Suspendisse bibendum magna ac ante vehicula lacinia. Nulla congue libero auctor tempus lobortis. ", 180, "History", "https://res.cloudinary.com/dwy4hhhjr/image/upload/w_270,h_400/v1691159845/nsd52xvnbsukash5izgz.jpg", new DateTime(2023, 7, 22, 0, 0, 0, 0, DateTimeKind.Unspecified), "Oppenheimer" },
                    { 7, "Aliquam et ornare libero, sed fermentum turpis. Praesent fermentum felis vitae consectetur maximus. Maecenas eu eleifend neque. Sed lorem lorem, commodo quis scelerisque feugiat, faucibus quis justo.", 150, "Action", "https://res.cloudinary.com/dwy4hhhjr/image/upload/w_270,h_400/v1691161775/shrek_q7kypt.jpg", new DateTime(2018, 11, 3, 0, 0, 0, 0, DateTimeKind.Unspecified), "Avengers: infinity war" },
                    { 8, "Curabitur luctus massa ligula, vitae vestibulum leo aliquam eu. Etiam a felis semper, mollis metus eget, sollicitudin ante. Cras ultricies arcu eu arcu scelerisque consectetur.", 110, "Animation", "https://res.cloudinary.com/dwy4hhhjr/image/upload/w_270,h_400/v1691161764/theGodfather_isikq1.jpg", new DateTime(2016, 3, 22, 0, 0, 0, 0, DateTimeKind.Unspecified), "Your name" },
                    { 9, "Sed ligula mauris, congue ac ex in, sagittis ultrices ante. Proin sagittis, ante sed consequat ornare, urna neque porttitor magna, ut posuere ante ligula nec libero. Maecenas lacinia ornare massa, at luctus sapien imperdiet nec.", 160, "Action", "https://res.cloudinary.com/dwy4hhhjr/image/upload/w_270,h_400/v1691159845/nsd52xvnbsukash5izgz.jpg", new DateTime(1999, 1, 2, 0, 0, 0, 0, DateTimeKind.Unspecified), "Matrix" },
                    { 10, "Aliquam quis gravida ipsum, ac sollicitudin orci. Ut iaculis mattis tincidunt. Duis quam risus, dignissim et ex in, vestibulum blandit erat. Nam vulputate est et iaculis pretium. Cras vitae purus enim. Integer ac condimentum turpis.", 150, "Drama", "https://res.cloudinary.com/dwy4hhhjr/image/upload/w_270,h_400/v1691161775/shrek_q7kypt.jpg", new DateTime(1999, 5, 23, 0, 0, 0, 0, DateTimeKind.Unspecified), "Fight club" }
          });
    }
